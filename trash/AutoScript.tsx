...
// import { Menu, MenuItem, Paper, TableContainer } from '@mui/material';

// const applications = [
//   { id: 'app-1', name: 'Payment Service' },
//   { id: 'app-2', name: 'Order Management' },
//   { id: 'app-3', name: 'User Authentication' },
//   { id: 'app-4', name: 'Reporting Engine' },
// ];
