    ...
    >
      <ReactMarkdown
        ...
        components={{
          ...
          //   // ✅ Detect if it's actually markdown content (like your file)
          ...
          //   console.log("looksLikeMarkdown : ", looksLikeMarkdown, " ||| text : ", text)
          ...
          //   if (looksLikeMarkdown) {
          //     text = normalizeMarkdown(text); // 🔥 THIS FIXES YOUR ISSUE
          //     return <MarkdownBlock content={text} fromCodeBlock  />;
          //   }
